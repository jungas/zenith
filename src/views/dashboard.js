...
import { statTile, statusPill, sectionHeader, emptyState } from '../ui/components.js';
import { meter, categoryBars } from '../ui/charts.js';
import { openTransactionForm, openPaymentForm, openFundCardForm, openAccountForm } from '../ui/forms.js';
...
import { debtSummary, upcomingPayments } from '../core/cards.js';
...
export function dashboardView({ month = currentMonth() } = {}) {
...
function cardTile(snap, money, month) {
